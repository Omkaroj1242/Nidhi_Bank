            ...
            <div class="container-fluid">
                <div class="row  pt-4">
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-8">
                        <h2 className='pt-3'>Bank Holidays</h2>

                        <section class="clear  pt-2">
                            
                            <table class="table table-bordered table-striped" width="73%" align="text-center" cellpadding="0" cellspacing="5">
                                <tbody><tr>
                                    <td class="font-bold text-center ">Sr. No.</td>
                                    <td class="font-bold text-center">Date</td>
                                    <td class="font-bold text-center">Holidays</td>
                                </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3" class="font-bold text-center tblifsc"><div>Holidays on Saturday and Sunday</div></td>
                                    </tr>
                                    <tr>
                                        <td class="tblifsc text-center">1</td>
                                    ...
                                    <tr>
                                        <td colspan="3" class="font-bold text-center tblifsc"><div>Year End Closing</div></td>
                                    </tr>
                                    <tr>
                                        <td class="tblifsc text-center">1</td>
