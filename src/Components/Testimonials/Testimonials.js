...
const Testimonials = () => {
  return (
    <div>
    <h1 className="text-6xl font-myFont text-center text-blue-400 py-4 my-8">Testimonials</h1>
      <div class="bg-white dark:bg-gray-800 w-full mx-auto p-8">
        ...
        />
        <p class="text-blue-600 dark:text-white w-full md:w-2/3 m-auto text-center text-lg md:text-3xl">
