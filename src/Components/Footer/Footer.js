        ...
        <footer class="relative bg-gray-100 pt-8 pb-6 bg-blue-500">
          <div class="container mx-auto px-4">
            <div class="flex flex-wrap text-left lg:text-left">
              ...
              <h3 className="text-3xl text-white font-myFont py-1">Manmandir Bank</h3>
                <h4 class="text-3xl  text-blue-400 font-myFont py-1">Let's keep in touch!</h4>
              ...
              <div class="w-full lg:w-6/12 px-4">
                <div class="flex flex-wrap items-top mb-6">
                  <div class="w-1/2 lg:w-4/12 px-4 ml-auto">
                    <span class="block uppercase text-blue-400 text-sm font-semibold pb-6">Useful Links</span>
                  ...
                  <div class="w-1/2 lg:w-4/12 px-4">
                    <span class="block uppercase text-blue-400 text-sm font-semibold pb-6">Other Resources</span>
                    <ul class="list-unstyled">
                      <li>
